<h2><a href="https://leetcode.com/problems/minimum-days-to-score-exactly-n-points">Minimum Days to Score Exactly N Points</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><p>You are given an integer <code>n</code> representing a target score.</p>
